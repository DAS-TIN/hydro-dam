...
handle('bisect:state', (cwd: string) => G.bisectState(cwd))
handle('bisect:start', (cwd: string, good: string, bad: string) => G.bisectStart(cwd, good, bad))
handle('bisect:mark', (cwd: string, verdict: 'good' | 'bad' | 'skip') => G.bisectMark(cwd, verdict))
handle('bisect:reset', (cwd: string) => G.bisectReset(cwd))
